...
with connect() as conn:
    ...
    if not conn.execute("select 1 from schema_migrations where id='20260914150000_accounts_sync'").fetchone():
        raise SystemExit('Explicit accounts activation must finish before this version starts.')
